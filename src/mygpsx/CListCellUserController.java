...
public class CListCellUserController implements Initializable{
    ...
    {
		// »щем сразу прив¤зку к сист. пользователю
		...
		ref.addListenerForSingleValueEvent(new ValueEventListener() {
			...
			public void onDataChange(DataSnapshot arg0)
			{
				...
				Platform.runLater(
						...
						alert.setTitle("”даление судна!");
						
						if(m_tempStructUser.getMySysUserBinding() == null)
						{
							m_tempStructUser.setMySysUserBinding("none");// Ёто дл¤ старых тестируемых пользователей!!!
						}
						if(m_tempStructUser.getMySysUserBinding().equals("none"))
						{
							alert.setHeaderText("¬ы действительно хотите удалить судно ?");
						}
						else
						{
							alert.setHeaderText("¬ы действительно хотите удалить судно,\nприв¤занное к пользователю:\n" + 
						...
						if (result.get() == buttonTypeYes)
						{
							try
							{
								...
								System.out.println("”даление судна.");
								CMyToast.makeText(CLPSMain.stage,
										"—удно успешно удалено!",
